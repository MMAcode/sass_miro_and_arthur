    ...
    return (
        <Blog author="Miroslav" date="06/04/2021" tabIndexForBlog={tabIndexForBlog}
            ...
            <article>
                ...
                <p>To support visually inpaired people and make navigation on this page easier using TAB key, we changed 'tabIndex' of each blog's title into 0. By default, tab key would move user on blog's title, but with this implementation, it picks our titles.</p>
