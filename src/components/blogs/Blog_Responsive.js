    ...
    return (
        <Blog author="Miro & Arthur"
            ...
            <article>
                ...
                {/*<BorderGradient>*/}
                    <div style={{padding:'10px', border:'1px dotted black', borderRadius:'5px'}}>
                        <h2 id="fullyResponsiveTitle">Fully responsive title</h2>
                        <p id="fullyResponsiveText" className="center">For example this title and text are using vw (view width) units.</p>
                    </div>
                {/*</BorderGradient>*/}
            </article>
        </Blog>
